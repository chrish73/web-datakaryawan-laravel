...
<div class="container">
    ...
    <div class="row mb-4 align-items-center">
        ...
        <div class="col-md-5 d-flex gap-2">
            <form action="{{ route('employees.import') }}" method="POST" enctype="multipart/form-data" class="d-flex w-100 gap-2">
                @csrf
        ...
        <div class="col-md-7">
            <form method="GET" action="{{ route('employees.index') }}" class="d-flex">
                <div class="input-group">
                    <input type="text" name="search" class="form-control" placeholder="Masukan Nama..." value="{{ $search }}">
    ...
    <div class="row">
        @forelse($employees as $employee)
            ...
            @endphp
            <div class="col-md-6 col-lg-4"> <div class="card employee-card">
        ...
        if (importForm) {
            ...
            importForm.addEventListener('submit', function() {
                ...
                if (!importButton.disabled) {
                    ...
                    importButton.innerHTML = '<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Loading...';
